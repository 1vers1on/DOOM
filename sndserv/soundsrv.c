...
int mix(void) {
    ...
    while(leftout != leftend) {
        ...
        if(channels[0]) {
            ...
            if(channels[0] >= channelsend[0]) channels[0] = 0;
        }
        ...
        if(channels[1]) {
            ...
            if(channels[1] >= channelsend[1]) channels[1] = 0;
        }
        ...
        if(channels[2]) {
            ...
            if(channels[2] >= channelsend[2]) channels[2] = 0;
        }
        ...
        if(channels[3]) {
            ...
            if(channels[3] >= channelsend[3]) channels[3] = 0;
        }
        ...
        if(channels[4]) {
            ...
            if(channels[4] >= channelsend[4]) channels[4] = 0;
        }
        ...
        if(channels[5]) {
            ...
            if(channels[5] >= channelsend[5]) channels[5] = 0;
        }
        ...
        if(channels[6]) {
            ...
            if(channels[6] >= channelsend[6]) channels[6] = 0;
        }
        if(channels[7]) {
            sample = *channels[7];
            ...
            if(channels[7] >= channelsend[7]) channels[7] = 0;
        }
